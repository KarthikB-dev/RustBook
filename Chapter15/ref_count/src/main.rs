...
fn main() {
    ...
    println!("After creating b, a's ref count is: {}", Rc::strong_count(&a));
    // This is disallowed because a has already been
    // moved to b (ownership has been transferred)
    // let c = Cons(4, Box::new(a));
    {
    let c = Cons(4, Rc::clone(&a));
    println!("After creating c, a's ref count is: {}", Rc::strong_count(&a));
    }
    println!("After c goes out of scope, a's ref count is: {}", Rc::strong_count(&a));
    println!("Hello, world!");
